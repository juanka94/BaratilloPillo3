				...
				<div class="row">
					<div class="col-sm-5">
						<div class="basic-login">
							<form action="" method="POST" role="form" role="form">
							<?php
	                        	if ($msgerror){
	                        ?>
                    		...
                    		?>
								<div class="form-group">
									...
									<input class="form-control" id="login-username" type="text" placeholder="" name="email">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<button type="submit" class="btn pull-right" name="btnlogin">Login</button>
					...
					<div class="col-sm-7 social-login">
						...
						<div class="not-member">
							<p>Not a member? <a href="registro.php">Register here</a></p>
						</div>
					</div>
				</div>
			</div>
